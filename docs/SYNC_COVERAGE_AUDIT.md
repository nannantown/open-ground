...
| S36 | △ | 「自分のみ」フィルタが名前ベースで正しく効く | 2点が未カバー。(1) identity マッピングが存在しない — 照合は文字列完全一致のみで、メールアドレス vs 表示名、'Koki' vs 'Koki … |
...
- **根拠**: /Users/kokinaniwa/projects/OPEN GROUND/src/lib/server/gitShare.ts:88,120-139,143-151,156-180; /Users/kokinaniwa/projects/OPEN GROUND/src/components/canvas/ProjectPanel.tsx:1086-1114,1367-1386; /Users/kokinaniwa/projects/OPEN GROUND/src/components/canvas/ProjectCard.tsx (share 参照ゼロ — grep 空); /Users/kokinaniwa/projects/OPEN GROUND/electron/main.js:180-188 (before-quit はサーバ停止のみ、未同期警告なし)
...
- **根拠**: /Users/kokinaniwa/projects/OPEN GROUND/src/lib/server/gitShare.ts:199-254 (commit→pull→conflict検知→abort→汎用message); /Users/kokinaniwa/projects/OPEN GROUND/src/components/canvas/ProjectPanel.tsx:994-1000 (conflict→汎用エラー通知のみ); /Users/kokinaniwa/projects/OPEN GROUND/src/i18n/messages/projectPanel.ts:214 (「同期が競合しました。手動で pull して解決してください。」); /Users/kokinaniwa/projects/OPEN GROUND/src/lib/server/gitShare.test.ts:260-287 (abort後もローカルコミット・内容保全を固定、ただし add/add 衝突)
