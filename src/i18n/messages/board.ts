...
export const board = {
  en: {
    ...
    'board.detail.tierLabel': 'Difficulty',
    'board.detail.tierHint':
      'How capable a worker this card gets in Optimize mode. Safety-sensitive cards (auth, deletion, billing…) never run below Design.',
    ...
    'board.detail.tier.standard.hint': 'Ordinary feature work. The default.',
    'board.detail.tier.design': 'Design',
    'board.detail.tier.design.hint': 'Structural or judgment-heavy work — more careful thinking.',
    'board.detail.tier.ultra': 'Ultra',
    'board.detail.tier.ultra.hint': 'The hardest work — the most capable model at maximum effort. Uses the scarcest budget.',
  ...
  ja: {
    ...
    'board.detail.tierLabel': '難易度',
    'board.detail.tierHint':
      '最適化モードで、このカードをどれだけ強いワーカーに任せるか。認証・削除・課金など安全に関わるカードは「設計」より下にはなりません。',
    ...
    'board.detail.tier.standard.hint': 'ふつうの機能追加。既定。',
    'board.detail.tier.design': '設計',
    'board.detail.tier.design.hint': '構造に関わる・判断が重い仕事。より深く考えさせます。',
    'board.detail.tier.ultra': '最難',
    'board.detail.tier.ultra.hint': 'いちばん難しい仕事だけ。最上位のモデルにいちばん深く考えさせます(いちばん貴重な枠を使います)。',
