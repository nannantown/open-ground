...
export const customTabs = {
  en: {
    ...
    'customTabs.localStarting': 'Starting…',
    'customTabs.localStartFailed': 'Couldn’t start',
    'customTabs.localStartFailed.not-found': 'The NENE project isn’t on your Ground.',
    'customTabs.localStartFailed.exited': 'It stopped right after starting.',
    'customTabs.localStartFailed.timeout': 'It didn’t respond in time.',
    'customTabs.localStartFailed.failed': 'OPEN GROUND couldn’t reach its own server.',
    'customTabs.localStartRetry': 'Try again',
  ...
  ja: {
    ...
    'customTabs.localStarting': '起動しています…',
    'customTabs.localStartFailed': '起動できませんでした',
    'customTabs.localStartFailed.not-found': 'NENE のプロジェクトが Ground に見つかりませんでした。',
    'customTabs.localStartFailed.exited': '起動してすぐに止まってしまいました。',
    'customTabs.localStartFailed.timeout': '時間内に応答がありませんでした。',
    'customTabs.localStartFailed.failed': 'OPEN GROUND 自身のサーバーにつながりませんでした。',
    'customTabs.localStartRetry': 'もう一度',
    // Sidebar (claude PTY in the module dir)
