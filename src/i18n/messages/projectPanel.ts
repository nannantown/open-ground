...
export const projectPanel = {
  en: {
    ...
    'projectPanel.swarm.seat.workerN': 'Worker {n}',
    'projectPanel.swarm.seat.rail': 'Folded seats',
    'projectPanel.swarm.seat.railTip': '{name} · {status}',
    'projectPanel.swarm.seat.fold': 'Fold this seat',
  ...
  ja: {
    ...
    'projectPanel.swarm.seat.workerN': 'ワーカー{n}',
    'projectPanel.swarm.seat.rail': '畳んだ席',
    'projectPanel.swarm.seat.railTip': '{name}・{status}',
    'projectPanel.swarm.seat.fold': 'この席を畳む',
