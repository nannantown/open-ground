...
export const screen = {
  en: {
    ...
    'screen.starter.body':
      'Double-click to edit the source, or ask Claude in Canvas chat to "make this screen into …". Tailwind and the project tokens (bg-bg-card / text-ink / accent / moss / ochre) plus lucide-react all work out of the box.',
  ...
  ja: {
    ...
    'screen.starter.body':
      'ダブルクリックでソースを編集、または Canvas チャットで Claude に「この画面を◯◯にして」と頼んでください。Tailwind と project tokens（bg-bg-card / text-ink / accent / moss / ochre）、lucide-react がそのまま使えます。',
