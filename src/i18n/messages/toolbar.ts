...
export const toolbar = {
  en: {
    ...
    'toolbar.searchHint': 'Up/Down to choose · Enter to fly there · Enter again (or click the card) to open it',
    'toolbar.searchLampWorking': 'Running',
    'toolbar.searchLampQuestion': 'Waiting for your answer',
    'toolbar.searchLampReview': 'Delivered — take a look',
  ...
  ja: {
    ...
    'toolbar.searchHint': '上下キーで選ぶ · Enter でそこへ移動 · もう一度 Enter(またはカードをクリック)で開く',
    'toolbar.searchLampWorking': '動いている',
    'toolbar.searchLampQuestion': 'あなたの答えを待っています',
    'toolbar.searchLampReview': '納品されました(見るだけ)',
  } as Record<string, string>,
}
