...
| **answer the task desk** (whenever it relayed something) | `POST $OG/api/swarm/supply/say` body `{"path":…,"text":"<plain-language answer, 1-3 lines>"}` — reporting landed work? add `"landed":["<full card id>",…]` (see step 9) |
